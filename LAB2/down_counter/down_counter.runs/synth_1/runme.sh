...
HD_PWD='C:/Users/shenc/OneDrive - nyu.edu/6463_AHD/LAB2/down_counter/down_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log down_counter_5236.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source down_counter_5236.tcl
