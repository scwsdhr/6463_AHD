...
HD_PWD='C:/Users/shenc/OneDrive - nyu.edu/6463_AHD/LAB2/up_counter/up_counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log up_counter_5236.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source up_counter_5236.tcl -notrace
