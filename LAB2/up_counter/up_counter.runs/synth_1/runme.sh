...
HD_PWD='C:/Users/shenc/OneDrive - nyu.edu/6463_AHD/LAB2/up_counter/up_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log up_counter_5236.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source up_counter_5236.tcl
