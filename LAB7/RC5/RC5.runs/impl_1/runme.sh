...
HD_PWD='C:/Users/UnFound/OneDrive - nyu.edu/6463_AHD/LAB7/RC5/RC5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rc5_fpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rc5_fpga.tcl -notrace
