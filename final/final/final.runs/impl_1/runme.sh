...
HD_PWD='C:/Users/UnFound/OneDrive - nyu.edu/6463_AHD/final/final/final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log controller_fpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source controller_fpga.tcl -notrace
