...
HD_PWD='C:/Users/UnFound/OneDrive - nyu.edu/6463_AHD/final/final/final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log controller_fpga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source controller_fpga.tcl
