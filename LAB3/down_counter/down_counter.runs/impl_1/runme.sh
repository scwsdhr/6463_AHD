...
HD_PWD='C:/Users/shenc/OneDrive - nyu.edu/6463_AHD/LAB3/down_counter/down_counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log down_counter_5236.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source down_counter_5236.tcl -notrace
