...
HD_PWD='C:/Users/shenc/OneDrive - nyu.edu/6463_AHD/midterm/midterm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mid_counter_fpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mid_counter_fpga.tcl -notrace
