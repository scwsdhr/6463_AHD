...
HD_PWD='C:/Users/shenc/OneDrive - nyu.edu/6463_AHD/midterm/midterm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mid_counter_fpga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mid_counter_fpga.tcl
